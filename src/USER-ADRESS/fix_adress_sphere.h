...
FixStyle(adress/sphere,FixAdressSphere)

#else

#ifndef LMP_FIX_WALL_ADRESS_SPHERE_H
#define LMP_FIX_WALL_ADRESS_SPHERE_H

#include "fix_adress.h"

namespace LAMMPS_NS {

class FixAdressSphere : public FixAdress {
 public:
  double factor;

  FixAdressSphere(class LAMMPS *, int, char **);
  void adress_weight();
};
